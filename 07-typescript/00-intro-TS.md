...
**TypeScript** — це надмножина JavaScript, яка додає статичну типізацію до мови. Це дозволяє виявляти помилки на етапі компіляції, покращує підтримку коду та полегшує розробку великих застосунків.

- **Розробник**: Microsoft
- **Основна особливість**: Статична типізація.
- **Транспіляціяz**: Код TypeScript компілюється в JavaScript, сумісний із браузерами та Node.js.
